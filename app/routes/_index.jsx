...
export default function Index() {
  return (
    <>
      <header className="h-auto bg-[#394264] text-white">
        <div className="max-w-4xl mx-auto flex justify-between items-center gap-6 pt-12 pb-20">
          <div>
            <h1 className="text-3xl font-bold capitalize max-w-xs">
          ...
          <div className="flex justify-center items-center relative  bg-green-300 rounded-[100%]">
